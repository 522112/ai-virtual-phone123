    ...
    sources: [
      ...
      { type: "indexeddb", dbName: "AiPhoneMomentsDB", label: "朋友圈记录" },
      {
        ...
        keys: [
          ...
          "ai_phone_douyin_npc_portraits_v1",
          "ai_phone_friend_requests_v1",
          "ai_phone_relationships_v1",
          "ai_phone_rel_posts_v1",
          "ai_phone_rel_comments_v1",
          "ai_phone_rel_checkins_v1",
          "ai_phone_rel_anniversaries_v1",
        ],
        prefixes: [
          "checkphone:xiaohongshu:readThreads",
          "xiaohongshu_events_",
          "ai_phone_xiaohongshu_events_",
          "ai_phone_douyin_events_",
        ],
      },
    ],
  },
