...
export const CONTENT_SCOPE_TAG_GROUPS: TagGroupProfile[] = [
    ...
    },
    {
        ...
        tags: ["douyin"],
        minors: [
            commonMinor("douyin", ["douyin"]),
            profile("douyin", "activity", "角色发作品/浏览", ["douyin", "activity"]),
            profile("douyin", "live", "直播互动", ["douyin", "live"]),
            profile("douyin", "audience", "观众弹幕", ["douyin", "audience"]),
            profile("douyin", "npc_live", "NPC直播刷新", ["douyin", "npc_live"]),
        ],
    },
...
const LEGACY_TAG_MIGRATIONS = new Map<string, string[]>([
    ...
    [JSON.stringify(["douyin", "character_activity"]), ["douyin", "activity"]],
    [JSON.stringify(["douyin", "live_action"]), ["douyin", "live"]],
    [JSON.stringify(["douyin", "audience_danmaku"]), ["douyin", "audience"]],
    [JSON.stringify(["douyin", "npc_live_refresh"]), ["douyin", "npc_live"]],
